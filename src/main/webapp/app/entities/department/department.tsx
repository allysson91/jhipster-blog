    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="blogApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="blogApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </h2>
